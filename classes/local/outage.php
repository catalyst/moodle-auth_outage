...
class outage {
    ...
    /**
     * By default, the outage will not lock down the whole site once it triggers maintenance mode.
     */
    const AUTO_START_OFF = 'off';

    /**
     * By default, the outage will lock down the whole site once it triggers maintenance mode.
     */
    const AUTO_START_ON = 'on';

    /**
     * By default, the outage will not lock down the whole site once it triggers maintenance mode.
     */
    const AUTO_START_FORCEOFF = 'forceoff';
